...
export function PreviewLayout() {
  return (
    <svg width="22" height="18" viewBox="0 0 22 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 9H16V12H13V14H18V9ZM6 6H9V4H4V9H6V6ZM22 0H0V18H22V0ZM20 16.01H2V1.99H20V16.01Z" />
    </svg>
  )
}
...
export function FormatCode() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path
        opacity="0.3"
        d="M9.99002 11.0101L9.00002 8.83008L8.01002 11.0101L5.83002 12.0001L8.01002 12.9901L9.00002 15.1701L9.99002 12.9901L12.17 12.0001L9.99002 11.0101Z"
      />
