...
describe('styled factory - button recipe', () => {
  ...
  test('variant styles', () => {
    ...
    expect(container.firstElementChild?.outerHTML).toMatchInlineSnapshot('"<button class=\\"button button--size_sm\\">Click me</button>"')
  })
  ...
  test('custom className', () => {
    ...
    expect(container.firstElementChild?.outerHTML).toMatchInlineSnapshot('"<button class=\\"button button--size_sm custom-btn\\">Click me</button>"')
  })
  ...
  test('style prop', () => {
    ...
    expect(container.firstElementChild?.outerHTML).toMatchInlineSnapshot('"<button class=\\"button mx_2 custom-btn\\">Click me</button>"')
  })
  ...
  test('style prop with variant', () => {
    ...
    expect(container.firstElementChild?.outerHTML).toMatchInlineSnapshot('"<button class=\\"button button--size_sm mx_2 custom-btn\\">Click me</button>"')
  })
  ...
  test('css prop', () => {
    ...
    expect(container.firstElementChild?.outerHTML).toMatchInlineSnapshot('"<button class=\\"button text_red.100 fs_md custom-btn\\">Click me</button>"')
  })
