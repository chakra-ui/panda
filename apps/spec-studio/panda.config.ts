  ...
  theme: {
    extend: {
      ...
      slotRecipes: {
        ...
        matrix: {
          className: "matrix",
          slots: ["scroll", "root", "colHead", "rowHead", "cell", "rowCell", "swatch"],
          base: {
            scroll: { overflowX: "auto", maxW: "full" },
            root: { borderCollapse: "collapse", w: "full", fontFamily: "mono", fontSize: "12.5px" },
            colHead: {
              textAlign: "center",
              fontWeight: "600",
              color: "muted",
