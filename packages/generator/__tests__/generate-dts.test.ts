...
test('[dts] should generate package', () => {
  ...
  expect(generateTokenTypes(ctx)).toMatchInlineSnapshot(`
    ...
    export type Size = \\"1\\" | \\"2\\" | \\"3\\" | \\"4\\" | \\"5\\" | \\"6\\" | \\"0.5\\" | \\"1.5\\" | \\"2.5\\" | \\"3.5\\" | \\"xs\\" | \\"sm\\" | \\"md\\" | \\"lg\\" | \\"xl\\" | \\"screen-sm\\" | \\"screen-md\\" | \\"screen-lg\\" | \\"screen-xl\\" | \\"screen-2xl\\"
