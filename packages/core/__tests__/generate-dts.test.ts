...
import { generateDts } from '../src/generate-dts'
...
test('[dts] should generate package', () => {
  ...
  expect(generateDts(dict)).toMatchInlineSnapshot(`
      Set {
        ...
        "export type Easing = \\"ease-in\\" | \\"ease-out\\"",
        "export type Duration = \\"75\\" | \\"100\\" | \\"150\\"",
        "export type TransitionProperty = \\"all\\" | \\"none\\" | \\"background\\" | \\"colors\\"",
