...
- 189d3bf: Keep generated CSS in sync when matching source files are created or deleted in Vite. Panda now watches
  configured source directories and handles Vite's create, update, and delete events.
