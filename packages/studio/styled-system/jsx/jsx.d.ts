...
export type JsxElement<T extends ElementType, P extends Dict> =
  T extends PandaComponent<infer A, infer B>
...
export type HTMLPandaProps<T extends ElementType> = JsxHTMLProps<
  ComponentProps<T>,
  JsxStyleProps
>;

export type PandaVariantProps<T extends PandaComponent<any, any>> =
  T extends PandaComponent<any, infer Props> ? Props : never;
