...
import type { RecipeBuilder, RecipeVariantRecord, RecipeConfig, SlotRecipeBuilder, SlotRecipeVariantRecord, SlotRecipeConfig } from './recipe';
...
declare module '@pandacss/dev' {
  ...
  export declare function defineRecipeConfigs(config: Record<string, RecipeConfig>): Record<string, Panda.RecipeConfig>;
