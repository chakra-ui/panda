...
export interface StandardLonghandProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
...
export interface StandardShorthandProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
...
export interface StandardProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends StandardLonghandProperties<TLength, TTime>,
    StandardShorthandProperties<TLength, TTime> {}

export interface VendorLonghandProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * The **`animation-delay`** CSS property specifies the amount of time to wait from applying the animation to an element before beginning to perform the animation. The animation can start later, immediately from its beginning, or immediately and partway through the animation.
   *
   * **Syntax**: `<time>#`
...
export interface VendorShorthandProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * The **`animation`** shorthand CSS property applies an animation between styles. It is a shorthand for `animation-name`, `animation-duration`, `animation-timing-function`, `animation-delay`, `animation-iteration-count`, `animation-direction`, `animation-fill-mode`, and `animation-play-state`.
   *
   * **Syntax**: `<single-animation>#`
...
export interface VendorProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> extends VendorLonghandProperties<TLength, TTime>, VendorShorthandProperties<TLength, TTime> {}

export interface ObsoleteProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
...
export interface SvgProperties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
...
export interface Properties<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
...
export interface StandardLonghandPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * The **`accent-color`** CSS property sets the accent color for user-interface controls generated by some elements.
   *
   * **Syntax**: `auto | <color>`
...
export interface StandardShorthandPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * The **`all`** shorthand CSS property resets all of an element's properties except `unicode-bidi`, `direction`, and CSS Custom Properties. It can set properties to their initial or inherited values, or to the values specified in another stylesheet origin.
   *
   * **Syntax**: `initial | inherit | unset | revert | revert-layer`
...
export interface StandardPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends StandardLonghandPropertiesHyphen<TLength, TTime>,
    StandardShorthandPropertiesHyphen<TLength, TTime> {}

export interface VendorLonghandPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * The **`animation-delay`** CSS property specifies the amount of time to wait from applying the animation to an element before beginning to perform the animation. The animation can start later, immediately from its beginning, or immediately and partway through the animation.
   *
   * **Syntax**: `<time>#`
...
export interface VendorShorthandPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * The **`animation`** shorthand CSS property applies an animation between styles. It is a shorthand for `animation-name`, `animation-duration`, `animation-timing-function`, `animation-delay`, `animation-iteration-count`, `animation-direction`, `animation-fill-mode`, and `animation-play-state`.
   *
   * **Syntax**: `<single-animation>#`
...
export interface VendorPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends VendorLonghandPropertiesHyphen<TLength, TTime>,
    VendorShorthandPropertiesHyphen<TLength, TTime> {}

export interface ObsoletePropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  /**
   * In combination with `elevation`, the **`azimuth`** CSS property enables different audio sources to be positioned spatially for aural presentation. This is important in that it provides a natural way to tell several voices apart, as each can be positioned to originate at a different location on the sound stage. Stereo output produce a lateral sound stage, while binaural headphones and multi-speaker setups allow for a fully three-dimensional stage.
   *
   * **Syntax**: `<angle> | [ [ left-side | far-left | left | center-left | center | center-right | right | far-right | right-side ] || behind ] | leftwards | rightwards`
...
export interface SvgPropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
...
export interface PropertiesHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
...
export type StandardLonghandPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<StandardLonghandProperties<TLength, TTime>>;

export type StandardShorthandPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<StandardShorthandProperties<TLength, TTime>>;

export interface StandardPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends StandardLonghandPropertiesFallback<TLength, TTime>,
    StandardShorthandPropertiesFallback<TLength, TTime> {}

export type VendorLonghandPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<VendorLonghandProperties<TLength, TTime>>;

export type VendorShorthandPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<VendorShorthandProperties<TLength, TTime>>;

export interface VendorPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends VendorLonghandPropertiesFallback<TLength, TTime>,
    VendorShorthandPropertiesFallback<TLength, TTime> {}

export type ObsoletePropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<ObsoleteProperties<TLength, TTime>>;

export type SvgPropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<SvgProperties<TLength, TTime>>;

export interface PropertiesFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
...
export type StandardLonghandPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<StandardLonghandPropertiesHyphen<TLength, TTime>>;

export type StandardShorthandPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<StandardShorthandPropertiesHyphen<TLength, TTime>>;

export interface StandardPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends StandardLonghandPropertiesHyphenFallback<TLength, TTime>,
    StandardShorthandPropertiesHyphenFallback<TLength, TTime> {}

export type VendorLonghandPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<VendorLonghandPropertiesHyphen<TLength, TTime>>;

export type VendorShorthandPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<VendorShorthandPropertiesHyphen<TLength, TTime>>;

export interface VendorPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
  extends VendorLonghandPropertiesHyphenFallback<TLength, TTime>,
    VendorShorthandPropertiesHyphenFallback<TLength, TTime> {}

export type ObsoletePropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<ObsoletePropertiesHyphen<TLength, TTime>>;

export type SvgPropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<SvgPropertiesHyphen<TLength, TTime>>;

export interface PropertiesHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }>
...
export namespace Property {
  ...
  export type AlignContent = Globals | DataType.ContentDistribution | DataType.ContentPosition | "baseline" | "normal" | (string & { __type?: never });

  export type AlignItems = Globals | DataType.SelfPosition | "baseline" | "normal" | "stretch" | (string & { __type?: never });

  export type AlignSelf = Globals | DataType.SelfPosition | "auto" | "baseline" | "normal" | "stretch" | (string & { __type?: never });

  export type AlignTracks = Globals | DataType.ContentDistribution | DataType.ContentPosition | "baseline" | "normal" | (string & { __type?: never });

  export type All = Globals;

  export type Animation<TTime = string & { __type?: never }> = Globals | DataType.SingleAnimation<TTime> | (string & { __type?: never });

  export type AnimationComposition = Globals | (string & { __type?: never });

  export type AnimationDelay<TTime = string & { __type?: never }> = Globals | TTime | (string & { __type?: never });

  export type AnimationDirection = Globals | DataType.SingleAnimationDirection | (string & { __type?: never });

  export type AnimationDuration<TTime = string & { __type?: never }> = Globals | TTime | (string & { __type?: never });

  export type AnimationFillMode = Globals | DataType.SingleAnimationFillMode | (string & { __type?: never });

  export type AnimationIterationCount = Globals | "infinite" | (string & { __type?: never }) | (number & { __type?: never });

  export type AnimationName = Globals | "none" | (string & { __type?: never });

  export type AnimationPlayState = Globals | "paused" | "running" | (string & { __type?: never });

  export type AnimationTimeline = Globals | DataType.SingleAnimationTimeline | (string & { __type?: never });

  export type AnimationTimingFunction = Globals | DataType.EasingFunction | (string & { __type?: never });

  export type Appearance = Globals | DataType.CompatAuto | "auto" | "menulist-button" | "none" | "textfield";

  export type AspectRatio = Globals | "auto" | (string & { __type?: never }) | (number & { __type?: never });
  ...
  export type BackdropFilter = Globals | "none" | (string & { __type?: never });

  export type BackfaceVisibility = Globals | "hidden" | "visible";

  export type Background<TLength = (string & { __type?: never }) | 0> = Globals | DataType.FinalBgLayer<TLength> | (string & { __type?: never });

  export type BackgroundAttachment = Globals | DataType.Attachment | (string & { __type?: never });

  export type BackgroundBlendMode = Globals | DataType.BlendMode | (string & { __type?: never });

  export type BackgroundClip = Globals | DataType.Box | (string & { __type?: never });

  export type BackgroundColor = Globals | DataType.Color;

  export type BackgroundImage = Globals | "none" | (string & { __type?: never });

  export type BackgroundOrigin = Globals | DataType.Box | (string & { __type?: never });

  export type BackgroundPosition<TLength = (string & { __type?: never }) | 0> = Globals | DataType.BgPosition<TLength> | (string & { __type?: never });

  export type BackgroundPositionX<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "center" | "left" | "right" | "x-end" | "x-start" | (string & { __type?: never });

  export type BackgroundPositionY<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "bottom" | "center" | "top" | "y-end" | "y-start" | (string & { __type?: never });

  export type BackgroundRepeat = Globals | DataType.RepeatStyle | (string & { __type?: never });

  export type BackgroundSize<TLength = (string & { __type?: never }) | 0> = Globals | DataType.BgSize<TLength> | (string & { __type?: never });

  export type BlockOverflow = Globals | "clip" | "ellipsis" | (string & { __type?: never });

  export type BlockSize<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type Border<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderBlock<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderBlockColor = Globals | DataType.Color | (string & { __type?: never });

  export type BorderBlockEnd<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderBlockEndColor = Globals | DataType.Color;

  export type BorderBlockEndStyle = Globals | DataType.LineStyle;

  export type BorderBlockEndWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderBlockStart<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderBlockStartColor = Globals | DataType.Color;

  export type BorderBlockStartStyle = Globals | DataType.LineStyle;

  export type BorderBlockStartWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderBlockStyle = Globals | DataType.LineStyle;

  export type BorderBlockWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderBottom<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderBottomColor = Globals | DataType.Color;

  export type BorderBottomLeftRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderBottomRightRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderBottomStyle = Globals | DataType.LineStyle;

  export type BorderBottomWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderCollapse = Globals | "collapse" | "separate";

  export type BorderColor = Globals | DataType.Color | (string & { __type?: never });

  export type BorderEndEndRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderEndStartRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderImage = Globals | "none" | "repeat" | "round" | "space" | "stretch" | (string & { __type?: never }) | (number & { __type?: never });

  export type BorderImageOutset<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never }) | (number & { __type?: never });

  export type BorderImageRepeat = Globals | "repeat" | "round" | "space" | "stretch" | (string & { __type?: never });

  export type BorderImageSlice = Globals | (string & { __type?: never }) | (number & { __type?: never });

  export type BorderImageSource = Globals | "none" | (string & { __type?: never });

  export type BorderImageWidth<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never }) | (number & { __type?: never });

  export type BorderInline<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderInlineColor = Globals | DataType.Color | (string & { __type?: never });

  export type BorderInlineEnd<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderInlineEndColor = Globals | DataType.Color;

  export type BorderInlineEndStyle = Globals | DataType.LineStyle;

  export type BorderInlineEndWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderInlineStart<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderInlineStartColor = Globals | DataType.Color;

  export type BorderInlineStartStyle = Globals | DataType.LineStyle;

  export type BorderInlineStartWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderInlineStyle = Globals | DataType.LineStyle;

  export type BorderInlineWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderLeft<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderLeftColor = Globals | DataType.Color;

  export type BorderLeftStyle = Globals | DataType.LineStyle;

  export type BorderLeftWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderRight<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderRightColor = Globals | DataType.Color;

  export type BorderRightStyle = Globals | DataType.LineStyle;

  export type BorderRightWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderSpacing<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderStartEndRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderStartStartRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderStyle = Globals | DataType.LineStyle | (string & { __type?: never });

  export type BorderTop<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type BorderTopColor = Globals | DataType.Color;

  export type BorderTopLeftRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderTopRightRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type BorderTopStyle = Globals | DataType.LineStyle;

  export type BorderTopWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type BorderWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | (string & { __type?: never });

  export type Bottom<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });
  ...
  export type BoxFlex = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type BoxFlexGroup = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type BoxLines = Globals | "multiple" | "single";

  export type BoxOrdinalGroup = Globals | (number & { __type?: never }) | (string & { __type?: never });
  ...
  export type BoxShadow = Globals | "none" | (string & { __type?: never });
  ...
  export type Clip = Globals | "auto" | (string & { __type?: never });

  export type ClipPath = Globals | DataType.GeometryBox | "none" | (string & { __type?: never });

  export type Color = Globals | DataType.Color;

  export type PrintColorAdjust = Globals | "economy" | "exact";

  export type ColorScheme = Globals | "dark" | "light" | "normal" | (string & { __type?: never });

  export type ColumnCount = Globals | "auto" | (number & { __type?: never }) | (string & { __type?: never });

  export type ColumnFill = Globals | "auto" | "balance" | "balance-all";

  export type ColumnGap<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "normal" | (string & { __type?: never });

  export type ColumnRule<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type ColumnRuleColor = Globals | DataType.Color;

  export type ColumnRuleStyle = Globals | DataType.LineStyle | (string & { __type?: never });

  export type ColumnRuleWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | (string & { __type?: never });

  export type ColumnSpan = Globals | "all" | "none";

  export type ColumnWidth<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto";

  export type Columns<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never }) | (number & { __type?: never });

  export type Contain = Globals | "content" | "inline-size" | "layout" | "none" | "paint" | "size" | "strict" | "style" | (string & { __type?: never });

  export type Content = Globals | DataType.ContentList | "none" | "normal" | (string & { __type?: never });

  export type ContentVisibility = Globals | "auto" | "hidden" | "visible";

  export type CounterIncrement = Globals | "none" | (string & { __type?: never });

  export type CounterReset = Globals | "none" | (string & { __type?: never });

  export type CounterSet = Globals | "none" | (string & { __type?: never });
  ...
  export type Filter = Globals | "none" | (string & { __type?: never });

  export type Flex<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | "content" | "fit-content" | "max-content" | "min-content" | "none" | (string & { __type?: never }) | (number & { __type?: never });

  export type FlexBasis<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type FlexFlow = Globals | "column" | "column-reverse" | "nowrap" | "row" | "row-reverse" | "wrap" | "wrap-reverse" | (string & { __type?: never });

  export type FlexGrow = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type FlexShrink = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type FlexWrap = Globals | "nowrap" | "wrap" | "wrap-reverse";

  export type Float = Globals | "inline-end" | "inline-start" | "left" | "none" | "right";

  export type Font = Globals | "caption" | "icon" | "menu" | "message-box" | "small-caption" | "status-bar" | (string & { __type?: never });

  export type FontFamily = Globals | DataType.GenericFamily | (string & { __type?: never });

  export type FontFeatureSettings = Globals | "normal" | (string & { __type?: never });

  export type FontKerning = Globals | "auto" | "none" | "normal";

  export type FontLanguageOverride = Globals | "normal" | (string & { __type?: never });

  export type FontOpticalSizing = Globals | "auto" | "none";

  export type FontSize<TLength = (string & { __type?: never }) | 0> = Globals | DataType.AbsoluteSize | TLength | "larger" | "smaller" | (string & { __type?: never });

  export type FontSizeAdjust = Globals | "from-font" | "none" | (string & { __type?: never }) | (number & { __type?: never });

  export type FontSmooth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.AbsoluteSize | TLength | "always" | "auto" | "never";

  export type FontStretch = Globals | DataType.FontStretchAbsolute;

  export type FontStyle = Globals | "italic" | "normal" | "oblique" | (string & { __type?: never });

  export type FontSynthesis = Globals | "none" | "small-caps" | "style" | "weight" | (string & { __type?: never });
  ...
  export type FontVariantAlternates = Globals | "historical-forms" | "normal" | (string & { __type?: never });

  export type FontVariantCaps = Globals | "all-petite-caps" | "all-small-caps" | "normal" | "petite-caps" | "small-caps" | "titling-caps" | "unicase";

  export type FontVariantEastAsian = Globals | DataType.EastAsianVariantValues | "full-width" | "normal" | "proportional-width" | "ruby" | (string & { __type?: never });
  ...
  export type FontVariationSettings = Globals | "normal" | (string & { __type?: never });

  export type FontWeight = Globals | DataType.FontWeightAbsolute | "bolder" | "lighter";

  export type ForcedColorAdjust = Globals | "auto" | "none";

  export type Gap<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "normal" | (string & { __type?: never });

  export type Grid = Globals | "none" | (string & { __type?: never });

  export type GridArea = Globals | DataType.GridLine | (string & { __type?: never });

  export type GridAutoColumns<TLength = (string & { __type?: never }) | 0> = Globals | DataType.TrackBreadth<TLength> | (string & { __type?: never });

  export type GridAutoFlow = Globals | "column" | "dense" | "row" | (string & { __type?: never });

  export type GridAutoRows<TLength = (string & { __type?: never }) | 0> = Globals | DataType.TrackBreadth<TLength> | (string & { __type?: never });

  export type GridColumn = Globals | DataType.GridLine | (string & { __type?: never });

  export type GridColumnEnd = Globals | DataType.GridLine;

  export type GridColumnGap<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type GridColumnStart = Globals | DataType.GridLine;

  export type GridGap<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type GridRow = Globals | DataType.GridLine | (string & { __type?: never });

  export type GridRowEnd = Globals | DataType.GridLine;

  export type GridRowGap<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type GridRowStart = Globals | DataType.GridLine;

  export type GridTemplate = Globals | "none" | (string & { __type?: never });

  export type GridTemplateAreas = Globals | "none" | (string & { __type?: never });

  export type GridTemplateColumns<TLength = (string & { __type?: never }) | 0> = Globals | DataType.TrackBreadth<TLength> | "none" | "subgrid" | (string & { __type?: never });

  export type GridTemplateRows<TLength = (string & { __type?: never }) | 0> = Globals | DataType.TrackBreadth<TLength> | "none" | "subgrid" | (string & { __type?: never });

  export type HangingPunctuation = Globals | "allow-end" | "first" | "force-end" | "last" | "none" | (string & { __type?: never });

  export type Height<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-max-content"
    | "-moz-min-content"
  ...
  export type HyphenateCharacter = Globals | "auto" | (string & { __type?: never });

  export type Hyphens = Globals | "auto" | "manual" | "none";

  export type ImageOrientation = Globals | "flip" | "from-image" | (string & { __type?: never });

  export type ImageRendering = Globals | "-moz-crisp-edges" | "-webkit-optimize-contrast" | "auto" | "crisp-edges" | "pixelated";

  export type ImageResolution = Globals | "from-image" | (string & { __type?: never });

  export type ImeMode = Globals | "active" | "auto" | "disabled" | "inactive" | "normal";

  export type InitialLetter = Globals | "normal" | (string & { __type?: never }) | (number & { __type?: never });

  export type InlineSize<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type Inset<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type InsetBlock<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type InsetBlockEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type InsetBlockStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type InsetInline<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type InsetInlineEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type InsetInlineStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type Isolation = Globals | "auto" | "isolate";

  export type JustifyContent = Globals | DataType.ContentDistribution | DataType.ContentPosition | "left" | "normal" | "right" | (string & { __type?: never });

  export type JustifyItems = Globals | DataType.SelfPosition | "baseline" | "left" | "legacy" | "normal" | "right" | "stretch" | (string & { __type?: never });

  export type JustifySelf = Globals | DataType.SelfPosition | "auto" | "baseline" | "left" | "normal" | "right" | "stretch" | (string & { __type?: never });

  export type JustifyTracks = Globals | DataType.ContentDistribution | DataType.ContentPosition | "left" | "normal" | "right" | (string & { __type?: never });

  export type Left<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type LetterSpacing<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "normal";

  export type LineBreak = Globals | "anywhere" | "auto" | "loose" | "normal" | "strict";

  export type LineClamp = Globals | "none" | (number & { __type?: never }) | (string & { __type?: never });

  export type LineHeight<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "normal" | (string & { __type?: never }) | (number & { __type?: never });

  export type LineHeightStep<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ListStyle = Globals | "inside" | "none" | "outside" | (string & { __type?: never });

  export type ListStyleImage = Globals | "none" | (string & { __type?: never });

  export type ListStylePosition = Globals | "inside" | "outside";

  export type ListStyleType = Globals | "none" | (string & { __type?: never });

  export type Margin<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginBlock<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginBlockEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginBlockStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginBottom<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginInline<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginInlineEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginInlineStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginLeft<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginRight<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type MarginTop<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type Mask<TLength = (string & { __type?: never }) | 0> = Globals | DataType.MaskLayer<TLength> | (string & { __type?: never });

  export type MaskBorder = Globals | "alpha" | "luminance" | "none" | "repeat" | "round" | "space" | "stretch" | (string & { __type?: never }) | (number & { __type?: never });

  export type MaskBorderMode = Globals | "alpha" | "luminance";

  export type MaskBorderOutset<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never }) | (number & { __type?: never });

  export type MaskBorderRepeat = Globals | "repeat" | "round" | "space" | "stretch" | (string & { __type?: never });

  export type MaskBorderSlice = Globals | (string & { __type?: never }) | (number & { __type?: never });

  export type MaskBorderSource = Globals | "none" | (string & { __type?: never });

  export type MaskBorderWidth<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never }) | (number & { __type?: never });

  export type MaskClip = Globals | DataType.GeometryBox | "no-clip" | (string & { __type?: never });

  export type MaskComposite = Globals | DataType.CompositingOperator | (string & { __type?: never });

  export type MaskImage = Globals | "none" | (string & { __type?: never });

  export type MaskMode = Globals | DataType.MaskingMode | (string & { __type?: never });

  export type MaskOrigin = Globals | DataType.GeometryBox | (string & { __type?: never });

  export type MaskPosition<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength> | (string & { __type?: never });

  export type MaskRepeat = Globals | DataType.RepeatStyle | (string & { __type?: never });

  export type MaskSize<TLength = (string & { __type?: never }) | 0> = Globals | DataType.BgSize<TLength> | (string & { __type?: never });

  export type MaskType = Globals | "alpha" | "luminance";

  export type MathDepth = Globals | "auto-add" | (string & { __type?: never }) | (number & { __type?: never });

  export type MathShift = Globals | "compact" | "normal";

  export type MathStyle = Globals | "compact" | "normal";

  export type MaxBlockSize<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-max-content"
    | "-moz-min-content"
  ...
  export type MaxHeight<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type MaxInlineSize<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type MaxLines = Globals | "none" | (number & { __type?: never }) | (string & { __type?: never });

  export type MaxWidth<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type MinBlockSize<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-max-content"
    | "-moz-min-content"
  ...
  export type MinHeight<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type MinInlineSize<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type MinWidth<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type Offset<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength> | DataType.GeometryBox | "auto" | "none" | (string & { __type?: never });

  export type OffsetDistance<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type OffsetPath = Globals | DataType.GeometryBox | "none" | (string & { __type?: never });

  export type OffsetRotate = Globals | "auto" | "reverse" | (string & { __type?: never });

  export type ObjectFit = Globals | "contain" | "cover" | "fill" | "none" | "scale-down";

  export type ObjectPosition<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength>;

  export type OffsetAnchor<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength> | "auto";

  export type Opacity = Globals | (string & { __type?: never }) | (number & { __type?: never });

  export type Order = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type Orphans = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type Outline<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Color | DataType.LineStyle | DataType.LineWidth<TLength> | "auto" | "invert" | (string & { __type?: never });

  export type OutlineColor = Globals | DataType.Color | "invert";

  export type OutlineOffset<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type OutlineStyle = Globals | DataType.LineStyle | "auto" | (string & { __type?: never });

  export type OutlineWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength>;

  export type Overflow = Globals | "-moz-hidden-unscrollable" | "auto" | "clip" | "hidden" | "scroll" | "visible" | (string & { __type?: never });
  ...
  export type OverflowClipMargin<TLength = (string & { __type?: never }) | 0> = Globals | DataType.VisualBox | TLength | (string & { __type?: never });
  ...
  export type OverscrollBehavior = Globals | "auto" | "contain" | "none" | (string & { __type?: never });
  ...
  export type Padding<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingBlock<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingBlockEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingBlockStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingBottom<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingInline<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingInlineEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingInlineStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingLeft<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingRight<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type PaddingTop<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });
  ...
  export type PaintOrder = Globals | "fill" | "markers" | "normal" | "stroke" | (string & { __type?: never });

  export type Perspective<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "none";

  export type PerspectiveOrigin<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength>;

  export type PlaceContent = Globals | DataType.ContentDistribution | DataType.ContentPosition | "baseline" | "normal" | (string & { __type?: never });

  export type PlaceItems = Globals | DataType.SelfPosition | "baseline" | "normal" | "stretch" | (string & { __type?: never });

  export type PlaceSelf = Globals | DataType.SelfPosition | "auto" | "baseline" | "normal" | "stretch" | (string & { __type?: never });
  ...
  export type Quotes = Globals | "auto" | "none" | (string & { __type?: never });

  export type Resize = Globals | "block" | "both" | "horizontal" | "inline" | "none" | "vertical";

  export type Right<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type Rotate = Globals | "none" | (string & { __type?: never });

  export type RowGap<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "normal" | (string & { __type?: never });
  ...
  export type RubyPosition = Globals | "alternate" | "inter-character" | "over" | "under" | (string & { __type?: never });

  export type Scale = Globals | "none" | (string & { __type?: never }) | (number & { __type?: never });

  export type ScrollBehavior = Globals | "auto" | "smooth";

  export type ScrollMargin<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type ScrollMarginBlock<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type ScrollMarginBlockEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginBlockStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginBottom<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginInline<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type ScrollMarginInlineEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginInlineStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginLeft<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginRight<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollMarginTop<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type ScrollPadding<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingBlock<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingBlockEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingBlockStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingBottom<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingInline<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingInlineEnd<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingInlineStart<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingLeft<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingRight<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollPaddingTop<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type ScrollSnapAlign = Globals | "center" | "end" | "none" | "start" | (string & { __type?: never });

  export type ScrollSnapCoordinate<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength> | "none" | (string & { __type?: never });

  export type ScrollSnapDestination<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength>;

  export type ScrollSnapPointsX = Globals | "none" | (string & { __type?: never });

  export type ScrollSnapPointsY = Globals | "none" | (string & { __type?: never });

  export type ScrollSnapStop = Globals | "always" | "normal";

  export type ScrollSnapType = Globals | "block" | "both" | "inline" | "none" | "x" | "y" | (string & { __type?: never });

  export type ScrollSnapTypeX = Globals | "mandatory" | "none" | "proximity";

  export type ScrollSnapTypeY = Globals | "mandatory" | "none" | "proximity";

  export type ScrollbarColor = Globals | "auto" | (string & { __type?: never });

  export type ScrollbarGutter = Globals | "auto" | "stable" | (string & { __type?: never });

  export type ScrollbarWidth = Globals | "auto" | "none" | "thin";

  export type ShapeImageThreshold = Globals | (string & { __type?: never }) | (number & { __type?: never });

  export type ShapeMargin<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type ShapeOutside = Globals | DataType.Box | "margin-box" | "none" | (string & { __type?: never });

  export type TabSize<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (number & { __type?: never }) | (string & { __type?: never });
  ...
  export type TextCombineUpright = Globals | "all" | "none" | (string & { __type?: never });

  export type TextDecoration<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | DataType.Color
    | TLength
    | "auto"
  ...
  export type TextDecorationLine = Globals | "blink" | "grammar-error" | "line-through" | "none" | "overline" | "spelling-error" | "underline" | (string & { __type?: never });

  export type TextDecorationSkip = Globals | "box-decoration" | "edges" | "leading-spaces" | "none" | "objects" | "spaces" | "trailing-spaces" | (string & { __type?: never });
  ...
  export type TextDecorationThickness<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | "from-font" | (string & { __type?: never });

  export type TextEmphasis = Globals | DataType.Color | "circle" | "dot" | "double-circle" | "filled" | "none" | "open" | "sesame" | "triangle" | (string & { __type?: never });

  export type TextEmphasisColor = Globals | DataType.Color;

  export type TextEmphasisPosition = Globals | (string & { __type?: never });

  export type TextEmphasisStyle = Globals | "circle" | "dot" | "double-circle" | "filled" | "none" | "open" | "sesame" | "triangle" | (string & { __type?: never });

  export type TextIndent<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });
  ...
  export type TextOverflow = Globals | "clip" | "ellipsis" | (string & { __type?: never });

  export type TextRendering = Globals | "auto" | "geometricPrecision" | "optimizeLegibility" | "optimizeSpeed";

  export type TextShadow = Globals | "none" | (string & { __type?: never });

  export type TextSizeAdjust = Globals | "auto" | "none" | (string & { __type?: never });

  export type TextTransform = Globals | "capitalize" | "full-size-kana" | "full-width" | "lowercase" | "none" | "uppercase";

  export type TextUnderlineOffset<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });

  export type TextUnderlinePosition = Globals | "auto" | "from-font" | "left" | "right" | "under" | (string & { __type?: never });

  export type Top<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto" | (string & { __type?: never });
  ...
  export type Transform = Globals | "none" | (string & { __type?: never });

  export type TransformBox = Globals | "border-box" | "content-box" | "fill-box" | "stroke-box" | "view-box";

  export type TransformOrigin<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "bottom" | "center" | "left" | "right" | "top" | (string & { __type?: never });

  export type TransformStyle = Globals | "flat" | "preserve-3d";

  export type Transition<TTime = string & { __type?: never }> = Globals | DataType.SingleTransition<TTime> | (string & { __type?: never });

  export type TransitionDelay<TTime = string & { __type?: never }> = Globals | TTime | (string & { __type?: never });

  export type TransitionDuration<TTime = string & { __type?: never }> = Globals | TTime | (string & { __type?: never });

  export type TransitionProperty = Globals | "all" | "none" | (string & { __type?: never });

  export type TransitionTimingFunction = Globals | DataType.EasingFunction | (string & { __type?: never });

  export type Translate<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "none" | (string & { __type?: never });
  ...
  export type VerticalAlign<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "baseline"
    | "bottom"
  ...
  export type Widows = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type Width<TLength = (string & { __type?: never }) | 0> =
    | Globals
    | TLength
    | "-moz-fit-content"
    | "-moz-max-content"
  ...
  export type WillChange = Globals | DataType.AnimateableFeature | "auto" | (string & { __type?: never });

  export type WordBreak = Globals | "break-all" | "break-word" | "keep-all" | "normal";

  export type WordSpacing<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "normal";
  ...
  export type ZIndex = Globals | "auto" | (number & { __type?: never }) | (string & { __type?: never });

  export type Zoom = Globals | "normal" | "reset" | (string & { __type?: never }) | (number & { __type?: never });
  ...
  export type MozBinding = Globals | "none" | (string & { __type?: never });

  export type MozBorderBottomColors = Globals | DataType.Color | "none" | (string & { __type?: never });

  export type MozBorderLeftColors = Globals | DataType.Color | "none" | (string & { __type?: never });

  export type MozBorderRightColors = Globals | DataType.Color | "none" | (string & { __type?: never });

  export type MozBorderTopColors = Globals | DataType.Color | "none" | (string & { __type?: never });

  export type MozContextProperties = Globals | "fill" | "fill-opacity" | "none" | "stroke" | "stroke-opacity" | (string & { __type?: never });

  export type MozFloatEdge = Globals | "border-box" | "content-box" | "margin-box" | "padding-box";

  export type MozForceBrokenImageIcon = Globals | 0 | (string & { __type?: never }) | 1;

  export type MozImageRegion = Globals | "auto" | (string & { __type?: never });

  export type MozOrient = Globals | "block" | "horizontal" | "inline" | "vertical";

  export type MozOutlineRadius<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type MozOutlineRadiusBottomleft<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type MozOutlineRadiusBottomright<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type MozOutlineRadiusTopleft<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type MozOutlineRadiusTopright<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });
  ...
  export type MsContentZoomLimit = Globals | (string & { __type?: never });

  export type MsContentZoomLimitMax = Globals | (string & { __type?: never });

  export type MsContentZoomLimitMin = Globals | (string & { __type?: never });

  export type MsContentZoomSnap = Globals | "mandatory" | "none" | "proximity" | (string & { __type?: never });

  export type MsContentZoomSnapPoints = Globals | (string & { __type?: never });

  export type MsContentZoomSnapType = Globals | "mandatory" | "none" | "proximity";

  export type MsContentZooming = Globals | "none" | "zoom";

  export type MsFilter = Globals | (string & { __type?: never });

  export type MsFlowFrom = Globals | "none" | (string & { __type?: never });

  export type MsFlowInto = Globals | "none" | (string & { __type?: never });

  export type MsGridColumns<TLength = (string & { __type?: never }) | 0> = Globals | DataType.TrackBreadth<TLength> | "none" | (string & { __type?: never });

  export type MsGridRows<TLength = (string & { __type?: never }) | 0> = Globals | DataType.TrackBreadth<TLength> | "none" | (string & { __type?: never });

  export type MsHighContrastAdjust = Globals | "auto" | "none";

  export type MsHyphenateLimitChars = Globals | "auto" | (string & { __type?: never }) | (number & { __type?: never });

  export type MsHyphenateLimitLines = Globals | "no-limit" | (number & { __type?: never }) | (string & { __type?: never });

  export type MsHyphenateLimitZone<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });
  ...
  export type MsScrollLimit = Globals | (string & { __type?: never });

  export type MsScrollLimitXMax<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto";

  export type MsScrollLimitXMin<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type MsScrollLimitYMax<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "auto";

  export type MsScrollLimitYMin<TLength = (string & { __type?: never }) | 0> = Globals | TLength;

  export type MsScrollRails = Globals | "none" | "railed";

  export type MsScrollSnapPointsX = Globals | (string & { __type?: never });

  export type MsScrollSnapPointsY = Globals | (string & { __type?: never });

  export type MsScrollSnapType = Globals | "mandatory" | "none" | "proximity";

  export type MsScrollSnapX = Globals | (string & { __type?: never });

  export type MsScrollSnapY = Globals | (string & { __type?: never });
  ...
  export type MsWrapMargin<TLength = (string & { __type?: never }) | 0> = Globals | TLength;
  ...
  export type WebkitBorderBefore<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | DataType.LineStyle | DataType.Color | (string & { __type?: never });

  export type WebkitBorderBeforeColor = Globals | DataType.Color;

  export type WebkitBorderBeforeStyle = Globals | DataType.LineStyle | (string & { __type?: never });

  export type WebkitBorderBeforeWidth<TLength = (string & { __type?: never }) | 0> = Globals | DataType.LineWidth<TLength> | (string & { __type?: never });

  export type WebkitBoxReflect<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "above" | "below" | "left" | "right" | (string & { __type?: never });

  export type WebkitLineClamp = Globals | "none" | (number & { __type?: never }) | (string & { __type?: never });

  export type WebkitMask<TLength = (string & { __type?: never }) | 0> =
    | Globals
  ...
  export type WebkitMaskAttachment = Globals | DataType.Attachment | (string & { __type?: never });

  export type WebkitMaskClip = Globals | DataType.Box | "border" | "content" | "padding" | "text" | (string & { __type?: never });

  export type WebkitMaskComposite = Globals | DataType.CompositeStyle | (string & { __type?: never });

  export type WebkitMaskImage = Globals | "none" | (string & { __type?: never });

  export type WebkitMaskOrigin = Globals | DataType.Box | "border" | "content" | "padding" | (string & { __type?: never });

  export type WebkitMaskPosition<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Position<TLength> | (string & { __type?: never });

  export type WebkitMaskPositionX<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "center" | "left" | "right" | (string & { __type?: never });

  export type WebkitMaskPositionY<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "bottom" | "center" | "top" | (string & { __type?: never });

  export type WebkitMaskRepeat = Globals | DataType.RepeatStyle | (string & { __type?: never });
  ...
  export type WebkitMaskSize<TLength = (string & { __type?: never }) | 0> = Globals | DataType.BgSize<TLength> | (string & { __type?: never });
  ...
  export type WebkitTextStroke<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Color | TLength | (string & { __type?: never });

  export type WebkitTextStrokeColor = Globals | DataType.Color;

  export type WebkitTextStrokeWidth<TLength = (string & { __type?: never }) | 0> = Globals | TLength;
  ...
  export type BaselineShift<TLength = (string & { __type?: never }) | 0> = Globals | TLength | "baseline" | "sub" | "super" | (string & { __type?: never });
  ...
  export type FillOpacity = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type FillRule = Globals | "evenodd" | "nonzero";

  export type FloodColor = Globals | DataType.Color | "currentColor";

  export type FloodOpacity = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type GlyphOrientationVertical = Globals | "auto" | (string & { __type?: never }) | (number & { __type?: never });

  export type LightingColor = Globals | DataType.Color | "currentColor";

  export type Marker = Globals | "none" | (string & { __type?: never });

  export type MarkerEnd = Globals | "none" | (string & { __type?: never });

  export type MarkerMid = Globals | "none" | (string & { __type?: never });

  export type MarkerStart = Globals | "none" | (string & { __type?: never });
  ...
  export type StopOpacity = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type Stroke = Globals | DataType.Paint;

  export type StrokeDasharray<TLength = (string & { __type?: never }) | 0> = Globals | DataType.Dasharray<TLength> | "none";

  export type StrokeDashoffset<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });

  export type StrokeLinecap = Globals | "butt" | "round" | "square";

  export type StrokeLinejoin = Globals | "bevel" | "miter" | "round";

  export type StrokeMiterlimit = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type StrokeOpacity = Globals | (number & { __type?: never }) | (string & { __type?: never });

  export type StrokeWidth<TLength = (string & { __type?: never }) | 0> = Globals | TLength | (string & { __type?: never });
...
export namespace AtRule {
  export interface CounterStyle<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  ...
  export interface CounterStyleHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  ...
  export type CounterStyleFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<CounterStyle<TLength, TTime>>;

  export type CounterStyleHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<CounterStyleHyphen<TLength, TTime>>;

  export interface FontFace<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  ...
  export interface FontFaceHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  ...
  export type FontFaceFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<FontFace<TLength, TTime>>;

  export type FontFaceHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<FontFaceHyphen<TLength, TTime>>;

  export interface Page<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
    bleed?: Bleed<TLength> | undefined;
    marks?: Marks | undefined;
    size?: Size<TLength> | undefined;
  }

  export interface PageHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
    bleed?: Bleed<TLength> | undefined;
    marks?: Marks | undefined;
    size?: Size<TLength> | undefined;
  }

  export type PageFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<Page<TLength, TTime>>;

  export type PageHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<PageHyphen<TLength, TTime>>;

  export interface Property<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
    inherits?: Inherits | undefined;
    initialValue?: string | undefined;
    syntax?: string | undefined;
  }

  export interface PropertyHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
    inherits?: Inherits | undefined;
    "initial-value"?: string | undefined;
    syntax?: string | undefined;
  }

  export type PropertyFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<Property<TLength, TTime>>;

  export type PropertyHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<PropertyHyphen<TLength, TTime>>;

  export interface Viewport<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
  ...
  export interface ViewportHyphen<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> {
    height?: Height<TLength> | undefined;
  ...
  export type ViewportFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<Viewport<TLength, TTime>>;

  export type ViewportHyphenFallback<TLength = (string & { __type?: never }) | 0, TTime = string & { __type?: never }> = Fallback<ViewportHyphen<TLength, TTime>>;

  type Range = "auto" | (string & { __type?: never });

  type SpeakAs = "auto" | "bullets" | "numbers" | "spell-out" | "words" | (string & { __type?: never });

  type System = "additive" | "alphabetic" | "cyclic" | "fixed" | "numeric" | "symbolic" | (string & { __type?: never });

  type FontFeatureSettings = "normal" | (string & { __type?: never });

  type AscentOverride = "normal" | (string & { __type?: never });

  type DescentOverride = "normal" | (string & { __type?: never });

  type FontDisplay = "auto" | "block" | "fallback" | "optional" | "swap";

  type FontStretch = DataType.FontStretchAbsolute | (string & { __type?: never });

  type FontStyle = "italic" | "normal" | "oblique" | (string & { __type?: never });
  ...
  type FontVariationSettings = "normal" | (string & { __type?: never });

  type FontWeight = DataType.FontWeightAbsolute | (string & { __type?: never });

  type LineGapOverride = "normal" | (string & { __type?: never });

  type Bleed<TLength> = TLength | "auto";

  type Marks = "crop" | "cross" | "none" | (string & { __type?: never });

  type Size<TLength> = DataType.PageSize | TLength | "auto" | "landscape" | "portrait" | (string & { __type?: never });

  type Inherits = "false" | "true";

  type Height<TLength> = DataType.ViewportLength<TLength> | (string & { __type?: never });

  type MaxHeight<TLength> = DataType.ViewportLength<TLength>;

  type MaxWidth<TLength> = DataType.ViewportLength<TLength>;

  type MaxZoom = "auto" | (string & { __type?: never }) | (number & { __type?: never });

  type MinHeight<TLength> = DataType.ViewportLength<TLength>;

  type MinWidth<TLength> = DataType.ViewportLength<TLength>;

  type MinZoom = "auto" | (string & { __type?: never }) | (number & { __type?: never });
  ...
  type Width<TLength> = DataType.ViewportLength<TLength> | (string & { __type?: never });

  type Zoom = "auto" | (string & { __type?: never }) | (number & { __type?: never });
}
...
export namespace DataType {
  ...
  type AnimateableFeature = "contents" | "scroll-position" | (string & { __type?: never });

  type Attachment = "fixed" | "local" | "scroll";

  type BgPosition<TLength> = TLength | "bottom" | "center" | "left" | "right" | "top" | (string & { __type?: never });

  type BgSize<TLength> = TLength | "auto" | "contain" | "cover" | (string & { __type?: never });
  ...
  type Color = NamedColor | DeprecatedSystemColor | "currentcolor" | (string & { __type?: never });
  ...
  type ContentList = Quote | "contents" | (string & { __type?: never });

  type ContentPosition = "center" | "end" | "flex-end" | "flex-start" | "start";

  type CubicBezierTimingFunction = "ease" | "ease-in" | "ease-in-out" | "ease-out" | (string & { __type?: never });

  type Dasharray<TLength> = TLength | (string & { __type?: never }) | (number & { __type?: never });
  ...
  type FinalBgLayer<TLength> = Color | BgPosition<TLength> | RepeatStyle | Attachment | Box | "none" | (string & { __type?: never });
  ...
  type FontWeightAbsolute = "bold" | "normal" | (number & { __type?: never }) | (string & { __type?: never });

  type GenericFamily = "cursive" | "fantasy" | "monospace" | "sans-serif" | "serif";

  type GeometryBox = Box | "fill-box" | "margin-box" | "stroke-box" | "view-box";

  type GridLine = "auto" | (string & { __type?: never }) | (number & { __type?: never });

  type LineStyle = "dashed" | "dotted" | "double" | "groove" | "hidden" | "inset" | "none" | "outset" | "ridge" | "solid";

  type LineWidth<TLength> = TLength | "medium" | "thick" | "thin";

  type MaskLayer<TLength> = Position<TLength> | RepeatStyle | GeometryBox | CompositingOperator | MaskingMode | "no-clip" | "none" | (string & { __type?: never });
  ...
  type Paint = Color | "child" | "context-fill" | "context-stroke" | "none" | (string & { __type?: never });

  type Position<TLength> = TLength | "bottom" | "center" | "left" | "right" | "top" | (string & { __type?: never });

  type Quote = "close-quote" | "no-close-quote" | "no-open-quote" | "open-quote";

  type RepeatStyle = "no-repeat" | "repeat" | "repeat-x" | "repeat-y" | "round" | "space" | (string & { __type?: never });
  ...
  type SingleAnimationTimeline = "auto" | "none" | (string & { __type?: never });

  type SingleTransition<TTime> = EasingFunction | TTime | "all" | "none" | (string & { __type?: never });

  type StepTimingFunction = "step-end" | "step-start" | (string & { __type?: never });

  type TrackBreadth<TLength> = TLength | "auto" | "max-content" | "min-content" | (string & { __type?: never });

  type ViewportLength<TLength> = TLength | "auto" | (string & { __type?: never });
