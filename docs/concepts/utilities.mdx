...
> This API is an advanced feature and should only be used if you want a custom system for your project. In our default
> preset, we've done most of the heavy lifting for you.

The utilities API is a way to create your own CSS properties, map existing properties to a set of values or tokens. It's
like building your own typesafe version of Chakra UI, Tailwind (in JS), Styled System, etc.

This provides an interface to:

- Map css properties to custom classNames
- Map css properties to a specific set of values or tokens
- Make your own css properties and transform them to css objects
- Mark custom shorthands for css properties
