...
The generated css is registered under the `recipe` [cascade layer](/concepts/cascade-layer) with the class name that
matches the recipe-variant name pattern `<recipe-name>--<variant-name>`.
