...
use encoder::Atom;
use extractor::Matchers;
use indoc::indoc;
use insta::assert_yaml_snapshot;
use project::{Matcher, NameMatcher, PandaProject};
...
fn builder_attaches_token_dictionary() {
    ...
    use encoder::AtomValue;
    use tokens::{Token, TokenCategory, TokenDictionary};
...
fn parsed_file_surfaces_diagnostics_per_file() {
    use project::DiagnosticSeverity;
    let mut project = PandaProject::new(matchers());
    let report = project.parse_file(
        "broken.tsx",
