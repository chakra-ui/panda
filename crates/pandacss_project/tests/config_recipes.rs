...
fn recipe_compound_variants_emit_all_on_first_usage() {
    ...
    compounds:
      - recipe: badge
        slot: ~
        className: badge--compound__raised_true__size_md
        entries:
          - prop: color
            value: tomato
            conditions: []
      - recipe: badge
        slot: ~
        className: badge--compound__raised_true__size_sm
        entries:
          - prop: color
...
fn recipe_compound_variants_emit_runtime_combo_with_eager_mode() {
    ...
    compounds:
      - recipe: button
        slot: ~
        className: button--compound__size_sm__variant_outline
        entries:
          - prop: color
            value: tomato
            conditions: []
...
fn recipe_compound_variant_array_value_means_any_of() {
    ...
    compounds:
      - recipe: badge
        slot: ~
        className: badge--compound__size_sm|md
        entries:
          - prop: color
            value: tomato
            conditions: []
...
fn recipe_compound_variants_combine_selected_conditions_with_smart_mode() {
    ...
    project.parse_file(
        ...
        indoc! {r"
            import { badge } from '@panda/recipes';
            badge({ size: { base: 'sm', md: 'md' }, raised: { md: true } });
        "},
    );
...
fn slot_recipe_compound_variants_emit_all_on_first_usage() {
    ...
    compounds:
      - recipe: tabs
        slot: trigger
        className: tabs__trigger--compound__active_true__size_md
        entries:
          - prop: color
            value: red
            conditions: []
      - recipe: tabs
        slot: trigger
        className: tabs__trigger--compound__active_true__size_sm
        entries:
          - prop: color
            value: blue
            conditions: []
...
fn slot_recipe_compound_variant_array_value_means_any_of() {
    ...
    compounds:
      - recipe: tabs
        slot: trigger
        className: tabs__trigger--compound__active_true__size_sm|md
        entries:
          - prop: color
            value: blue
            conditions: []
