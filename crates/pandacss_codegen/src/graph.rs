...
fn generate_node(
    ...
    match node.id {
        ...
        ArtifactId::Css => crate::artifacts::css::generate(ctx, options, node.dependencies),
        ArtifactId::CssIndex => {
            crate::artifacts::css_index::generate(ctx, options, node.dependencies)
        }
        ...
        ArtifactId::JsxCreateSlotRecipeContext => {
            crate::artifacts::jsx::generate_create_slot_recipe_context(
                ctx,
                options,
                node.dependencies,
            )
        ...
        ArtifactId::JsxFactory => {
            crate::artifacts::jsx::generate_factory(ctx, options, node.dependencies)
        }
        ArtifactId::JsxHelper => {
            crate::artifacts::jsx::generate_jsx_helper(ctx, options, node.dependencies)
        }
        ArtifactId::JsxIndex => {
            crate::artifacts::jsx::generate_index(ctx, options, node.dependencies)
        }
        ArtifactId::JsxIsValidProp => {
            crate::artifacts::jsx::generate_is_valid_prop(ctx, options, node.dependencies)
        }
        ArtifactId::JsxPatterns => {
            crate::artifacts::jsx::generate_patterns(ctx, options, node.dependencies)
        }
        ArtifactId::Patterns => {
            crate::artifacts::patterns::generate(ctx, options, node.dependencies)
        }
        ArtifactId::Recipes => crate::artifacts::recipes::generate(ctx, options, node.dependencies),
        ArtifactId::Types => crate::artifacts::types::generate(ctx, options, node.dependencies),
    }
}
