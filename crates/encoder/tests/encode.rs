...
use extractor::{ExtractorConfig, Matcher, Matchers, NameMatcher, extract};
use indoc::indoc;
...
fn first_arg(source: &str, name: &str) -> extractor::Literal {
...
fn custom_condition_matcher_recognizes_named_conditions() {
    struct Custom;
    impl encoder::ConditionMatcher for Custom {
