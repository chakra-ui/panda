...
use crate::plan::{HelperCxMode, TransformHelperFacts};
...
pub(crate) fn plan_internal_css_import_line(
    ...
    let needs_cx = helper_cx != HelperCxMode::False
        && (helper.needs_cx
            || crate::imports::local_binding_used(source, CX_HELPER_LOCAL, dead_span()));
    let needs_cva = helper.needs_cva
        || crate::imports::local_binding_used(source, CVA_HELPER_LOCAL, dead_span());
    let needs_sva = helper.needs_sva
        || crate::imports::local_binding_used(source, SVA_HELPER_LOCAL, dead_span());
...
pub fn sync_internal_css_import(
    ...
    crate::apply::apply_helper_sync(source, path, helper, helper_cx)
}
...
mod tests {
    ...
    fn remove_internal_css_import_strips_indented_import() {
        ...
        let edits = crate::imports::plan_internal_css_import_removals(source, "fixture.ts");
        let out = crate::apply::project_edits(source, &edits);
