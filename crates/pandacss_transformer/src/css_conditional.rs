...
use crate::jsx::parse::{ParsedObjectLiteral, parse_object_literal, parse_static_string};
use crate::resolve::{call_arg_span, classes_for_css_args};
...
fn css_property_expression(prop: &crate::jsx::parse::ParsedProperty) -> Option<String> {
    if prop.spread {
