...
[static CSS](/docs/styling/static#recipes).
...
Runtime-only combos need [`staticCss`](/docs/styling/static#recipes). Run `pnpm panda codegen` after editing
the recipe.
...
Learn more about the [extend](/docs/theming/extend) keyword.
...
[dynamic variant props](#dynamic-variant-props). See [Generating recipes](/docs/styling/static#recipes).
