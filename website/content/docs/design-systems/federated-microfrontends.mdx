...
> one the [Component Library guide](/docs/design-systems/overview#ship-the-build-info-file)
...
[shipping build info](/docs/design-systems/overview#ship-the-build-info-file)
