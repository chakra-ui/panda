...
For a [config recipe](/docs/styling/recipes#config-recipe) authored outside `defineConfig`.
...
Same idea, for a [slot recipe](/docs/styling/slot-recipes#config-slot-recipe).
