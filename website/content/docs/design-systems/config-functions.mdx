...
For a [config recipe](/docs/recipes/recipes#config-recipe) authored outside `defineConfig`.
...
Same idea, for a [slot recipe](/docs/recipes/slot-recipes#config-slot-recipe).
...
For a [pattern](/docs/design-systems/patterns) authored outside `defineConfig`.
...
For a [preset](/docs/design-systems/presets#creating-a-preset).
...
For a [plugin](/docs/design-systems/hooks#sharing-a-hook), the object that carries a shareable `hooks` map.
...
For a custom [utility](/docs/design-systems/utilities) authored outside `defineConfig`.
