...
ship a [preset](/docs/theming/presets).
...
Do not put the design system in `include`. That errors with `design_system_in_include`. The package loads through
`designSystem`, nothing else.
