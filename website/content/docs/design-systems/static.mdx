...
[dynamic variant props](/docs/styling/recipes#dynamic-variant-props) for why static analysis misses those.
...
[Storybook](/docs/styling/storybook): every variant needs to render, whether or not your stories happen to call it.
