...
[JSX Style Context](/docs/recipes/jsx-style-context), this page is
...
[withRootProvider](/docs/recipes/jsx-style-context#withrootprovider) for that case.
...
[Config Recipes](/docs/recipes/jsx-style-context#config-recipes) for the exact rule.
...
forget to mention it exists. See [unstyled prop](/docs/recipes/jsx-style-context#unstyled-prop) for the exact
...
attribute, list it in `forwardProps`. See [Forwarding props](/docs/recipes/jsx-style-context#forwarding-props) for
