...
plus one or more [presets](/docs/theming/presets). It's a different problem from [Federated
...
[Presets merge in order, and later entries win on conflicts](/docs/theming/presets#extend-on-top-from-the-app).
...
[Hooks](/docs/theming/hooks#filter-a-preset-before-it-merges) for the rest of what `preset:resolved` can do.
...
- [Presets](/docs/theming/presets) for how preset merging and `theme.extend` work.
- [Hooks](/docs/theming/hooks#filter-a-preset-before-it-merges) for the `preset:resolved` example this page's fix is based on.
