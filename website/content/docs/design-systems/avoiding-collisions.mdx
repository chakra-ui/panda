...
[Presets merge in order, and later entries win on conflicts](/docs/design-systems/presets#extend-on-top-from-the-app).
...
[Hooks](/docs/design-systems/hooks#filter-a-preset-before-it-merges) for the rest of what `preset:resolved` can do.
...
- [Hooks](/docs/design-systems/hooks#filter-a-preset-before-it-merges) for the `preset:resolved` example this page's fix is based on.
