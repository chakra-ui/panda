...
thin wrappers over it, and it's the same core the [ESLint & OXLint Plugin](/docs/tooling/eslint-oxlint-plugin) is
...
- [Diagnostics Reference](/docs/reference/diagnostics) for the specific issues this tooling is meant to surface
  live.
- [ESLint & OXLint Plugin](/docs/tooling/eslint-oxlint-plugin) for the sibling tool sharing the same underlying
  project metadata.
