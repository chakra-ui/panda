---
title: JSON Spec
description: A JSON description of your theme, tokens, and recipes for documentation sites and Storybook.
---
...
`styled-system/specs/semantic-tokens.json`. The other files below describe the wider shape this format is moving toward.
