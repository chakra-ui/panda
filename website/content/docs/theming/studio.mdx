---
title: Studio
description: A CLI-generated token viewer for v2, with getTokenJson, getTokenHtml, and getTokenCss. Not in the beta yet.
---

<Callout type="warning">
  Coming soon. `panda studio` isn't in the v2 beta yet. This page previews the shape so you can plan around it. The v1
  `@pandacss/studio` Astro app is removed in v2.
</Callout>

## What's coming

The v1 Panda Studio was a separate Astro app: install a framework, boot a server, self-host to share. The Rust
migration removed that pipeline, so v2 has no built-in way to look at your tokens today.
...
- [JSON Spec](/docs/theming/json-spec) for a data export you can render in your own docs.
