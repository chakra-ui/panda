...
`.svelte`, and `.astro` single-file components directly, so the [Vue](/docs/get-started/vue), [Svelte](/docs/get-started/svelte),
and [Astro](/docs/get-started/astro) install pages have no plugin to add. If you're upgrading from v1, the separate
