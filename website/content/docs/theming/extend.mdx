...
- [conditions](/docs/theming/conditions)
- [theme](/docs/theming/theme)
- [recipes](/docs/recipes/config-recipe) (included in theme)
...
> These keys are all allowed in [presets](/docs/theming/presets).
...
[here](/docs/theming/minimal-setup)
