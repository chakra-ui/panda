...
| `--logfile <file>`            | Outputs logs to a file                                        | [Debugging](/docs/references/debugging)                           |
...
| `--cpu-prof`            | Generate a `panda-{command}-{timestamp}.cpuprofile` file for profiling | [Debugging](/docs/references/debugging)                               |
| `--logfile <file>`      | Outputs logs to a file                                                 | [Debugging](/docs/references/debugging)                               |
...
More details in [Debugging](/docs/references/debugging) docs.
...
| `--config, -c <path>` | Path to Panda config file                                              | [`config`](/docs/references/config.md)                    |
| `--cwd <path>`        | Current working directory                                              | [`config.cwd`](/docs/references/config#cwd)               |
| `--cpu-prof`          | Generate a `panda-{command}-{timestamp}.cpuprofile` file for profiling | [Debugging](/docs/references/debugging#performance-profiling) |
| `--logfile <file>`    | Outputs logs to a file                                                 | [Debugging](/docs/references/debugging)                       |
