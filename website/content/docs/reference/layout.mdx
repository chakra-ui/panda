...
> [`AspectRatio` pattern](/docs/styling/patterns#aspect-ratio) instead
...
[Read more.](/docs/styling/conditional-styles#container-queries)
...
<UtilityTable groups={['Layout', 'Position', 'Container']} />
