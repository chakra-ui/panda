...
There is a detailed guide on how to do this [here](/docs/component-library/overview).

---

## Can I use dynamic styles with Panda?

Yes, you can use dynamic styles with Panda. More on that [here](/docs/concepts/dynamic-styling#runtime-conditions).
...
[`config.staticCss`](https://panda-css.com/docs/concepts/dynamic-styling#using-static-css), it's generally **not
