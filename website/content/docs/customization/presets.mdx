...
- **Component libraries** — consumers add your preset in `panda.config.ts`
  ([component library guide](/docs/component-library/overview#ship-a-panda-preset))

If the app does not use Panda, ship static CSS instead. See the
[component library guide](/docs/component-library/overview) for other options.
...
[Ship a Panda preset](/docs/component-library/overview#ship-a-panda-preset).
...
- [`staticCss`](/docs/distribution/static)
...
[here](/docs/distribution/minimal-setup)
