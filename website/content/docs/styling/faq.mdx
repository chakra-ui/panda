...
You can get an [`atomic recipe`](/docs/styling/recipes#atomic-recipe) properties types by using `RecipeVariantProps`.
...
This contrasts with [Atomic recipes](/docs/styling/recipes#atomic-recipe) (cva), which generates all of the variants
