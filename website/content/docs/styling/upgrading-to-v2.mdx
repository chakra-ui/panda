...
- **Studio.** The Astro-based `@pandacss/studio` app is gone; `panda studio` replaces it with a CLI-generated viewer and
  three framework-agnostic functions. See [Panda Studio](/docs/theming/studio).
