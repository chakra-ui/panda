...
- **Two new options appear**: `designSystem` (see [Consuming a design system](/docs/design-systems/consuming-a-design-system))
...
- [Consuming a design system](/docs/design-systems/consuming-a-design-system): the planned `designSystem` config
  field.
- [Panda Studio](/docs/theming/studio): the Astro app replaced by a live viewer plus `getTokenJson` / `getTokenHtml`.
