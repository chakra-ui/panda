...
[you're tracking those components in your recipe config](/docs/recipes/recipes#advanced-jsx-tracking).
...
> _and_ pass it to your component, see [forwarding props](/docs/recipes/jsx-style-context#forwarding-props) in
