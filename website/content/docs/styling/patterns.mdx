...
Change defaults in [config](/docs/design-systems/patterns#changing-a-patterns-defaults). `HStack` and `VStack` are separate
...
Change defaults in [config](/docs/design-systems/patterns#changing-a-patterns-defaults).
