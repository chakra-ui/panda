...
Change defaults in [config](/docs/customization/patterns#changing-pattern-defaults). `HStack` and `VStack` are separate
...
Change defaults in [config](/docs/customization/patterns#changing-pattern-defaults).
...
See [custom component props](/docs/concepts/style-props#custom-component-props).
