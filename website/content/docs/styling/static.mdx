...
<Callout type="info">
  Looking for build-time rewriting of `css()` calls into plain class strings? That's [source transforms](/docs/get-started/source-transforms), a separate opt-in feature.
</Callout>
...
[dynamic variant props](/docs/recipes/config-recipe#dynamic-variant-props) for why static analysis misses those.
...
[Storybook](/docs/get-started/storybook): every variant needs to render, whether or not your stories happen to call it.
