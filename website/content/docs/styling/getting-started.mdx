...
- [Panda CLI](/docs/styling/cli): The simplest way to use Panda is with the Panda CLI tool.

- [Using PostCSS](/docs/styling/postcss): (**Recommended**) Installing Panda as a PostCSS plugin is the recommended
