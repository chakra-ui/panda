...
description: How to safely run multiple Panda-built applications (and multiple versions of the same design system) on a single host page using `prefix` and `cssVarRoot` — whether your design system ships static CSS or build info.
---
...
> one the [Component Library guide](/docs/component-library/overview#ship-the-build-info-file)
...
[shipping build info](/docs/component-library/overview#ship-the-build-info-file)
...
- [Component Library](/docs/component-library/overview) — distribution
