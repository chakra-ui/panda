...
See [Why Panda → How it works](/docs/get-started/why-panda#how-it-works) for the model it keeps.
...
- [Why Panda → How it works](/docs/get-started/why-panda#how-it-works) — the mental model v2 keeps.
