...
Panda's [recipes](/docs/recipes/overview) formalize this as a typed variant map, the prop and its allowed values are
...
See [Recipes](/docs/recipes/overview) and [Slot Recipes](/docs/recipes/slot-recipes) for multi-part components.
