...
Panda's [recipes](/docs/recipes/atomic-recipe) formalize this as a typed variant map, the prop and its allowed values are
...
See [Recipes](/docs/recipes/atomic-recipe) and [Slot Recipes](/docs/recipes/slot-recipes) for multi-part components.
