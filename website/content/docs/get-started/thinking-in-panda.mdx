...
- [Recipes](/docs/recipes/overview): `cva`, config recipes, slots, and JSX.
- [Slot Recipe](/docs/recipes/slot-recipes): `sva` for parts. Shared form is on
  [Config Recipe](/docs/recipes/config-recipe#config-slot-recipe).
