...
Want the case for build-time styles first? Read [Welcome to Panda](/docs/get-started/why-panda).
...
- [Welcome to Panda](/docs/get-started/why-panda): install Panda and generate your first styles.
