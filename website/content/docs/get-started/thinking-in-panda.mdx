...
Full API: [Recipes](/docs/recipes/atomic-recipe).
...
[Should I use atomic or config recipes?](/docs/recipes/config-recipe#should-i-use-atomic-or-config-recipes-). The same split
...
- [Recipes](/docs/recipes/atomic-recipe): `cva` and config recipes.
