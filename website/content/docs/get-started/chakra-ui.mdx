...
Panda's equivalent is a [recipe](/docs/recipes/overview), either colocated with `cva`/`sva` or shared globally via
...
See [Recipes](/docs/recipes/overview) and [Slot Recipes](/docs/recipes/slot-recipes).
