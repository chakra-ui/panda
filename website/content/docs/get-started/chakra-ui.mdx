...
engine, not a component library. If you need those without Chakra's runtime styling, wrap a headless library like
Ark UI. See [Wrap headless libraries](/docs/design-systems/wrap-headless-libraries).
...
- [Migration strategy](/docs/get-started/migration-strategy) for running both libraries side by side during the
  migration.
- [Wrap headless libraries](/docs/design-systems/wrap-headless-libraries) if you need Chakra-like interactive components without
  Chakra's runtime.
