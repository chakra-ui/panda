...
Panda's [recipes](/docs/recipes/overview) replace this with a typed, declarative variant map, no manual prop-to-style
branching:
...
equivalent safety net. See [Recipes](/docs/recipes/overview) and [Slot Recipes](/docs/recipes/slot-recipes).
