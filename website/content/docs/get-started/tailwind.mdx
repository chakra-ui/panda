...
`tailwind-variants`. Panda has this built in as [recipes](/docs/recipes/overview):
...
[Recipes](/docs/recipes/overview) and [Slot Recipes](/docs/recipes/slot-recipes) for multi-part components.
...
[recipe](/docs/recipes/overview) or the [`cx`](/docs/styling/merging-styles) helper for the same composition instead.
...
- [Writing Styles](/docs/styling/writing-styles) and [Recipes](/docs/recipes/overview) for the two APIs this guide
  leans on most.
