...
thin wrappers over it, and it's the same core the [ESLint & OXLint Plugin](/docs/get-started/eslint-plugin) is
...
- [Diagnostics Reference](/docs/reference/diagnostics) for the specific issues this tooling is meant to surface
  live.
- [ESLint & OXLint Plugin](/docs/get-started/eslint-plugin) for the sibling tool sharing the same underlying
  project metadata.
