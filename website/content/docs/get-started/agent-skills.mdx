...
<Callout type="info">
  ...
  that works today, see [LLMs.txt](/docs/tooling/llms-txt) and [MCP Server](/docs/tooling/mcp-server).
</Callout>
...
- **[LLMs.txt](/docs/tooling/llms-txt)** hands an agent the documentation itself, a static content dump for context.
- **[MCP Server](/docs/tooling/mcp-server)** answers "what exists right now" in your specific project, live token,
...
- [LLMs.txt](/docs/tooling/llms-txt) and [MCP Server](/docs/tooling/mcp-server) for the AI-facing tooling that
  exists today.
