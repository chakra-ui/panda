...
> one the [Component Library guide](/docs/guides/component-library#ship-the-build-info-file)
...
[shipping build info](/docs/guides/component-library#ship-the-build-info-file)
